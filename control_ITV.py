    ...
    for i in Cl_list:
        if i != 1:
            ...
            if 0 == r[0]:
                print("Wrote!")
                if(value > 10):
                    label_list[i] = tk.Label(master=window, text="Pressure (psi): 130.5")
                    label_list[i]['font'] = myFont
                    label_list[i].grid(row=i+1, column=1, sticky="nsew")
                else:
                    label_list[i] = tk.Label(master=window, text="Pressure (psi): 0")
                    label_list[i]['font'] = myFont
                    label_list[i].grid(row=i+1, column=1, sticky="nsew")
            else:
